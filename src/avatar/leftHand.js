// src/avatar/leftHand.js
import * as THREE from 'three';
import { materials } from './materials.js';

export function addLeftHand(bones) {
  ...
  wrist.rotation.y = -Math.PI / 2; // Palma para o corpo

  bones.leftForearm.add(wrist);
  bones.leftWrist = wrist;
  ...
  // DEDOS: grow in Y now
  // FIXED: Thumb on opposite face (Z-axis) from other fingers
  const config = [
    { name: 'thumb', x: -0.14, y: 0.08, z: -0.05, rotZ: 1.0, rotX: Math.PI / 2 },
